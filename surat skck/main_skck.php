...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stylemainskck.css">
</head>
<body>
    <div class="bg">
                    ...
                    <div class="card-body" style="max-height: 406px;overflow-y: scroll;">
                        <blockquote class="blockquote mb-0">
                            <?php    
                                $nik = $_POST['nik'];
                            ?>    
                            <form action="save_skck.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="maksud_tujuan" name="maksud_tujuan" required="required" rows="3"></textarea>
                                </div>
