...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stylemainizinramerame.css">
                ...
                <div class="card justify-content-center setForm">
                    ...
                    <div class="card-body" style="max-height: 406px;overflow-y: scroll;">
                        <blockquote class="blockquote mb-0">
                            ...
                            $nik = $_POST['nik'];
                            ?>
                            <form action="save_izin_rame_rame.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" name="tujuan_acara" style="">
                                </div>
                                <div class="form-group">
                                    <label for="tgl_acara">Tanggal</label>
                                    <input type="date" class="form-control" required="required" name="tgl_acara" style="">
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="hari_acara">Hari</label>
                                        <input type="text" class="form-control " required="required" name="hari_acara">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="jam_acara">Jam</label>
                                        <input type="text" class="form-control" required="required" name="jam_acara">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="nama_acara">Hiburan</label>
                                    <input type="text" class="form-control" required="required" name="nama_acara">
                                </div>
