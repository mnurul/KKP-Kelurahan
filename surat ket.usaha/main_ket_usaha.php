...
<head>
    ...
    <!-- <script type="text/javascript" src="../sweetalert-master/docs/assets/sweetalert/sweetalert.min.js"></script> -->
    <link rel="stylesheet" type="text/css" href="styleketusaha.css">
</head>
<body>
    <div class="bg">
                    ...
                    <div class="card-body" style="max-height: 406px;overflow-y: scroll;">
                        <blockquote class="blockquote mb-0">
                            <?php    
                                $nik = $_POST['nik'];
                            ?>    
                            <form action="save_ket_usaha.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required="required" id="jenis_usaha" name="jenis_usaha" style="text-transform:uppercase">
                                </div>
                                <div class="form-group">
                                    <label for="alamat_usaha">Alamat Usaha</label>
                                    <input type="text" class="form-control" required="required" name="alamat_usaha">
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="kelurahan_usaha">Kelurahan</label>
                                        <input type="text" class="form-control" required="required" name="kelurahan_usaha" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="kecamatan_usaha">Kecamatan</label>
                                        <input type="text" class="form-control" required="required" name="kecamatan_usaha">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="kota_usaha">Kota</label>
                                    <input type="text" class="form-control" required="required" name="kota_usaha">
                                </div>
