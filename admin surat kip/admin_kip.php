...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style_admin_kip.css">
</head>
<body>
    <div class="bg">
                ...
                <div class="card-body ScrollStyle">
                    <blockquote class="blockquote mb-0">
                        <table class="table table-hover table-sm table-responsive w-auto text-nowrap">
                            ...
                            <?php
                                // $no = 1;
                                $data = mysqli_query($con,"SELECT b.nik, UPPER(b.nama), b.tempat, date_format(b.tgl_lahir,'%d-%m-%Y ') as tgl_lahir, b.jkel, b.alamat, b.kewarganegaraan, b.agama, b.status_perkawinan, b.pekerjaan, a.no_sku, a.nik_orang_tua,a.tgl_pengajuan FROM surat_kip a INNER JOIN warga b ON a.nik = b.nik");
                            ...
                            <tbody>
                                ...
                                <td><?= $row['pekerjaan'];?></td>
                                <td><?= $row['alamat'];?></td>
                                <td><?= $row['nik_orang_tua'];?></td>
                                <td><?= $row['tgl_pengajuan'];?></td>
                                <td><a href="print_kip.php?no_sku=<?= $row['no_sku'];?>" target="_blank"><i class="fa fa-print fa-2x" aria-hidden="true"></i></a></td>
                                </tr>
                            </tbody>
                            <?php
                                }
