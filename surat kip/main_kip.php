...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stylemainkip.css">
</head>
<body>
    <div class="bg">
                    ...
                    <div class="card-body" style="max-height: 406px;overflow-y: scroll;">
                        <blockquote class="blockquote mb-0">
                            <?php    
                                $nik = $_POST['nik'];
                            ?>    
                            <form action="save_kip.php" method="post">
                                <div class="form-group">
                                    <label for="nik">NIK</label>
                                    <input type="text" class="form-control" required="required" value="<?= $nik ?>" name="nik" required autofocus readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nik_orang_tua">NIK Orang Tua Kandung</label>
                                    <input type="text" class="form-control" required="required"  name="nik_orang_tua" style="">
                                </div>
